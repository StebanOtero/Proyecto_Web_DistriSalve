      ...
      <Container>
        <div className="content-wrapper-context">
          <span className="titulo">
            {<v.iconoempresa />}
            Bienvenido al portal de Gestión de Inventarios
          </span>
          ...
          <ContentSocial>
            <CardDatosEmpresa
              titulo="Misión"
              descripcion="Satisfacer a los clientes, teniendo todos un compromiso hacia la microempresa"
            />
            <CardDatosEmpresa
              titulo="Visión"
              descripcion="Consolidarnos en el 2026, como distribuidora líder en las zonas aledañas de Cali"
            />
            <CardDatosEmpresa
              titulo="Valores"
              descripcion="Responsabilidad, puntualidad, compromiso, respeto, honestidad y pasión"
            />
          </ContentSocial>
        </div>
